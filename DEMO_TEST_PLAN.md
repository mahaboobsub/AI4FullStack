...
.\venv\Scripts\python.exe -m data.seed_three_phones
```
...
**Pass:** Backend log: `Bolna call INITIATED`  
...
**Pass:** Toast success; upcoming dates appear
...
1. Staff login → sidebar shows your name/hospital (click avatar to expand)
